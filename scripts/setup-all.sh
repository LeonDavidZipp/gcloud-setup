...
echo "----------------------------------------------"
"$SCRIPT_DIR/02-create-service-account.sh"
echo ""

echo "Step 3/4: Setting up Workload Identity Federation..."
echo "----------------------------------------------"
"$SCRIPT_DIR/03-iam-setup.sh"
echo ""

echo "Step 4/4: Creating Artifact Registry..."
echo "----------------------------------------------"
"$SCRIPT_DIR/04-artifact-registry-setup.sh"
echo ""
